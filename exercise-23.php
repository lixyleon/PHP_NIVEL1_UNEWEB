...
<body>
    ...
    //str_word_count() - cuenta las palabras en una cadenas de caracteres
    echo '<br>';
    echo str_word_count('Buenas tardes');
    // strrev() coloca en sentido contrario los caracteres de una cadena
    echo '<br>';
    ...
    echo strpos('Buenos dias','noches'); // false no lo  muestra
    
    // str_replace() reemplaza un texto en una cadena de caracteres.

    echo '<br>';
    echo str_replace('tardes','noches','Buenas tardes');// salidas Buenas noches
